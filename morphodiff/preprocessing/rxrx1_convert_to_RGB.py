...
if __name__ == '__main__':
    ...
    # this is how you can load one image and convert it to RGB
    t = load_site('train', 'HUVEC-01', 2, 'J12', 2)
    print(t.shape)
    x = convert_tensor_to_rgb(t)
    print(x.shape)

    # change channels of each image to 2,1,0
    x = x[:, :, ::-1]

    # save x as a png image
    cv2.imwrite('HUVEC-01_Plate2_J12_s2_original.png', x)
